...
export class TaptoolsService {
   ...
   * @param policy - Collection policy ID
   */
  async getNFTCollectionHoldersDistribution(
    policy: string
   ...
   */
  async getNFTCollectionTraitPrices(
    policy: string,
    name?: string
   ...
   */
  async getWalletPortfolioPositions(
    address: string
