...
${CARDANO_GET_TRENDING_TOKENS_NAME} will return the trending tokens in the market

${CARDANO_GET_TOP_TRADERS_NAME} will return information about the top traders in the market.

${CARDANO_GET_TRADER_TRADES_NAME} will return information about the trades for a trader.
