...
1. Amount of ADA to stake. (optional)
2. The contract address of the liquid staking provider to use.

If a user asks to stake and provides a symbol, use the ${CARDANO_GET_TOKEN_DATA_NAME} tool to get the contract address of the liquid staking provider to use.
