...
import type { CardanoLiquidStakingYieldsResultBodyType } from "./types";
import type { CardanoAction } from "../../cardano-action";


export class CardanoLiquidStakingYieldsAction implements CardanoAction<typeof LiquidStakingYieldsInputSchema, CardanoLiquidStakingYieldsResultBodyType> {
