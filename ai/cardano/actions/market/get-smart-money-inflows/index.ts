...
export class CardanoGetSmartMoneyInflowsAction implements CardanoAction<typeof GetSmartMoneyInflowsInputSchema, CardanoGetSmartMoneyInflowsResultBodyType> {
