...
import {
  RegisterBasenameSchemaType,
  RegisterBasenameResultBodyType,
} from './types';

export class RegisterBasenameAction
  implements
    CdpAction<RegisterBasenameSchemaType, RegisterBasenameResultBodyType>
{
