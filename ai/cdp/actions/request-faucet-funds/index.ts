...
import type {
  RequestFaucetFundsSchemaType,
  RequestFaucetFundsResultBodyType,
} from './types';

export class RequestFaucetFundsAction
  implements
    CdpAction<RequestFaucetFundsSchemaType, RequestFaucetFundsResultBodyType>
{
