import { CARDANO_TOKEN_PAGE_PRICE_ANALYSIS_NAME, SOLANA_TOKEN_PAGE_PRICE_ANALYSIS_NAME } from "./name";
import { CARDANO_TOKEN_PAGE_PRICE_ANALYSIS_PROMPT, SOLANA_TOKEN_PAGE_PRICE_ANALYSIS_PROMPT } from "./prompt";
...
export class CardanoTokenPagePriceAnalysisAction implements TokenPageAction<typeof TokenPagePriceAnalysisInputSchema, TokenPagePriceAnalysisResultBodyType> {
