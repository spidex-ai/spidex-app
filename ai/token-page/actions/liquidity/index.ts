import {
  CARDANO_TOKEN_PAGE_LIQUIDITY_NAME,
  SOLANA_TOKEN_PAGE_LIQUIDITY_NAME,
} from './name';
import {
  CARDANO_TOKEN_PAGE_LIQUIDITY_PROMPT,
  SOLANA_TOKEN_PAGE_LIQUIDITY_PROMPT,
} from './prompt';
...
export class SolanaTokenPageLiquidityAction
  implements
    TokenPageAction<
      typeof TokenPageLiquidityInputSchema,
...
export class CardanoTokenPageLiquidityAction
  implements
    TokenPageAction<
      typeof TokenPageLiquidityInputSchema,
      TokenPageLiquidityResultBodyType
