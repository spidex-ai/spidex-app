      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          ...
          {loading && !collectionStats ? (
            ...
            <p className="text-2xl font-bold text-gray-800">
              {collectionStats.volume?.toLocaleString() || 'N/A'} ADA
            </p>
          ) : (
            <p className="text-gray-500">No data available</p>
          )}
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          ...
          {loading && !collectionStats ? (
            ...
            <p className="text-2xl font-bold text-gray-800">
              {collectionStats.listings?.toLocaleString() || 'N/A'}
            </p>
          ) : (
            <p className="text-gray-500">No data available</p>
          )}
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-800">
                  {collectionStats.supply?.toLocaleString() || 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-800">
                  {collectionStats.supply && collectionStats.owners
                    ? (
                        (collectionStats.owners / collectionStats.supply) *
                        100
                      ).toFixed(2) + '%'
                    : 'N/A'}
                </span>
          ...
          {loading && !collectionStats ? (
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-800">
                  {collectionStats.sales?.toLocaleString() || 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-700">Top Offer:</span>
                <span className="font-medium text-gray-800">
                  {collectionStats.topOffer?.toLocaleString() || 'N/A'} ADA
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-800">
                  {collectionStats.volume && collectionStats.sales
                    ? (collectionStats.volume / collectionStats.sales).toFixed(
                        2
                      ) + ' ADA'
                    : 'N/A'}
                </span>
