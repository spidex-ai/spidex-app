  ...
  return (
    <Card className="p-2 flex flex-col gap-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-2">
        ...
        <div className="flex flex-col">
          <h3 className="text-sm font-semibold">Circulating Supply</h3>
          <p>
            $
            {token?.mcap?.circSupply?.toLocaleString(undefined, {
              maximumFractionDigits: 2,
            }) || 'N/A'}
          </p>
        </div>
        <div className="flex flex-col">
          <h3 className="text-sm font-semibold">Total Supply</h3>
          <p>
            {token?.mcap?.totalSupply?.toLocaleString(undefined, {
