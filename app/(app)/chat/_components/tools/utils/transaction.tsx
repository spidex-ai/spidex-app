  ...
  return (
    <div>
      <div className="grid grid-cols-5">
        <div className="col-span-3 flex items-center justify-center">Tx Hash</div>
...
const Transaction: React.FC<Props> = ({
  ...
  return (
    <Card className="grid grid-cols-5 items-center gap-2 p-2 my-2 cursor-pointer" onClick={onClick}>
