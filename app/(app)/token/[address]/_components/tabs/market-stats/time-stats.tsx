  ...
  return (
    <div className="flex flex-col border rounded-md border-neutral-200 dark:border-neutral-700">
          ...
          return (
            <Button
              ...
              className={cn(
                ...
                timePeriod === period &&
                  'bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-700'
              )}
            >
              <span>{label}</span>
      ...
      <div className="flex flex-col px-2">
        ...
        <StatSection
          label="TXNS"
          total={transactions.total.toLocaleString(undefined, {
            notation: 'compact',
        ...
        <StatSection
          label="VOLUME"
          total={volume.total.toLocaleString(undefined, {
            notation: 'compact',
            maximumFractionDigits: 0,
          })}
          buy={volume.buyVol}
        ...
        <StatSection
          label="MAKERS"
          total={makers.total.toLocaleString(undefined, {
            notation: 'compact',
            maximumFractionDigits: 0,
          })}
          buy={makers.buyers}
  ...
  return (
    <div className="flex gap-2 items-center h-16">
      <div className="flex flex-col w-24">
        <h3 className="text-xs text-neutral-600 dark:text-neutral-400 font-semibold">
          {label}
        </h3>
