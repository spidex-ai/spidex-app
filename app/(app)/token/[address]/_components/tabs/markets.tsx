      ...
      <TableBody className="h-0 overflow-y-auto no-scrollbar">
        {markets?.items.map(market => (
          <TableRow key={market.address}>
            ...
            <TableCell className="w-48">{market.name}</TableCell>
            <TableCell>
              $
            ...
            <TableCell>
              {market.trade24h.toLocaleString(undefined, {
            ...
            <TableCell>
              {market.uniqueWallet24h.toLocaleString(undefined, {
                maximumFractionDigits: 0,
                notation: 'compact',
              })}
              {market.uniqueWallet24hChangePercent !== null && (
                <span
                  className={
                    market.uniqueWallet24hChangePercent > 0
                      ? 'text-green-500'
                      : 'text-red-500'
                  }
                >
                  {' '}
                  ({market.uniqueWallet24hChangePercent.toFixed(2)}%)
                </span>
              )}
            </TableCell>
          </TableRow>
