...
export const POST = async (req: NextRequest) => {
  ...
  do {
    ...
    //     completed: 0,
    //     creditsUsed: 1,
    //     next: 'https://api.firecrawl.dev/v1/crawl/ae5c456e-ffa6-4d20-a849-a6de55e89050?skip=0',
    //     expiresAt: 2025-04-23T07:09:30.000Z,
    //     data: []
    //   }
    const statusResponse: any = await firecrawl.checkCrawlStatus(
      crawlResponse.id
    );
    console.log(
      "🚀 ~ POST ~ statusResponse:",
