...
const WALLET_METHODS = [
  {
    ...
    link: 'https://chromewebstore.google.com/detail/lace/gafhhkghbfjjkeiendhlofajokpaflmk?hl=en',
  },
  {
    id: 'yoroi',
    name: 'Yoroi',
  ...
  },
  {
    ...
    link: 'https://chromewebstore.google.com/detail/gero-dashboard/bgpipimickeadkjlklgciifhnalhdjhe',
  },
  {
    id: 'subwallet',
    name: 'Sub Wallet',
    ...
    link: 'https://chromewebstore.google.com/detail/subwallet-polkadot-wallet/onhogfjeacnfoofkfgppdlbmlmnplgbn',
  },
  {
    id: 'begin',
    name: 'Begin',
  ...
  },
  {
    ...
    link: 'https://chromewebstore.google.com/detail/typhon-wallet/kfdniefadaanbjodldohaedphafoffoh',
  },
  {
    id: 'nufi',
    name: 'Nufi',
...
const LoginModal: React.FC = () => {
  ...
  const extractWalletNameFromError = (errorMessage: string): string | null => {
    ...
    for (const pattern of patterns) {
      ...
      if (match && match[1]) {
        ...
        const wallet = WALLET_METHODS.find(
          w => w.id.toLowerCase() === extractedName
        );
        if (wallet) {
          return wallet.id;
        }
  ...
  const handleDiscordCallback = useCallback(
    async (code: string, baseRedirectUri: string) => {
      ...
      try {
        ...
        if (typeof window !== 'undefined') {
          ...
          window.history.replaceState({}, '', url);
          console.log('Cleaned up OAuth parameters from URL');
        }
  ...
  useEffect(() => {
    ...
    if (
      ...
      console.log(
        'Login Modal: Skipping OAuth processing - conditions not met or on page with dedicated OAuth handler'
      );
    }
