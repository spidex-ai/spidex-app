...
const TaptoolsTestPage = () => {
  const [activeTab, setActiveTab] = useState<'token' | 'nft' | 'market' | 'address' | 'trades'>('token');

  return (
    <div className="container mx-auto p-8 bg-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Taptools API Demo</h1>
      ...
      <div className="bg-gray-100 rounded-lg shadow-lg p-6">
        {activeTab === 'token' && (
          <TaptoolsTokenDashboard
            tokenUnit="8fef2d34078659493ce161a6c7fba4b56afefa8535296a5743f6958741414441"
          />
        )}
        
        {activeTab === 'nft' && (
          <TaptoolsNFTDashboard
